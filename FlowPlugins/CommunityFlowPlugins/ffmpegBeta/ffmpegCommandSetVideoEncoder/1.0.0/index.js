...
var details = function () { return ({
    ...
    inputs: [
        ...
        },
        {
            ...
            tooltip: 'Specify whether to set crf (or qp for GPU encoding). Disable this if using SetVideoBitrate plugin.',
        },
        {
...
var plugin = function (args) { return __awaiter(void 0, void 0, void 0, function () {
    var lib, hardwareDecoding, hardwareType, i, stream, targetCodec, _a, ffmpegPresetEnabled, ffmpegQualityEnabled, ffmpegPreset, ffmpegQuality, forceEncoding, hardwarEncoding, encoderProperties, hasBitrateSet;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                ...
                // NEW: Check if bitrate is already set by another plugin
                hasBitrateSet = stream.outputArgs.some(function (arg) {
                    return arg.includes('-b:v:') || arg.includes('-b:V:');
                });
                
                if (ffmpegQualityEnabled) {
                    if (hasBitrateSet) {
                        args.jobLog('WARNING: Bitrate already set by another plugin. Skipping CRF/QP to avoid conflict.');
                        args.jobLog('To use CRF/QP, disable the SetVideoBitrate plugin or disable quality here.');
                    } else {
