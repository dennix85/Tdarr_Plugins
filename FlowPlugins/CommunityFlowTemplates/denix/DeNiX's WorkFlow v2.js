...
var details = function () { return ({
  name: "DeNiX's Workflow v2 (online repo)",
  description: "DeNiX's Workflow v2 (online repo)",
  tags: "",
  flowPlugins: [
    {
    ...
    },
    {
      ...
      inputsDB: {
        ...
        include_hdr_info: "true",
        insert_missing_codec_info: "true",
        custom_tag: "[TDARR]",
        preserve_existing_tags: "true",
        remove_dots_before_release_tags: "true",
        additional_extensions: ".nfo,.srt,.ass,.sup,.idx,.sub,.ssa,.bin,.json"
      },
      fpEnabled: true,
      id: "kSJa0dzZG",
      position: {
